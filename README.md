...
1. **Address entry:** The address field autocompletes when [Mapbox Search Box](https://docs.mapbox.com/api/search/search-box/) or [Smarty US Autocomplete Pro](https://www.smarty.com/docs/cloud/us-autocomplete-pro-api) is configured. Users can also type a full address and submit.
